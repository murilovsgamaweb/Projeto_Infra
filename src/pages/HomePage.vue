    ...
    <div class="p-6 md:p-8 w-full max-w-md border border-[#A6A6A6] bg-[#F0F4F8] shadow-[0px_4px_4px_rgba(0,0,0,0.25)] rounded-[20px]">
      <div class="mb-6 relative">
        ...
        <div class="relative">
          ...
          <button
            class="absolute inset-y-0 right-0 px-3 flex items-center text-white rounded-[15px] focus:outline-none focus:ring-2 focus:ring-opacity-50 transition duration-200 hover:bg-[#FF7F00]"
